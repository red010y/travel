...
//import org.apache.spark.scheduler.{SparkListener, SparkListenerTaskEnd, SparkListenerTaskGettingResult}
...
//    //监听task的任务的状态，是否失败
//    val failed: Boolean = taskGettingResult.taskInfo.failed
//      //任务失败了
//    if(failed){
//      taskGettingResult.taskInfo.executorId
//      //继续发送邮件
//    }
//  }
//
